      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="nav nav-pills bg-dark text-secondary">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link text-white">Requerimentos</a>
            </li>
            <li class="nav-item">
  ...
  <div class="py-5 bg-light">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card text-white p-5 bg-danger">
            <div class="card-body">
              <h1 class="mb-4">Alterar senha</h1>
              <form action="redefinir" method="POST">
                <div class="form-group"> <label>Senha atual:</label>
                  <input type="text" class="form-control" placeholder="Senha Atual" name="senhaautal" value=""> </div>
                <div class="form-group"> <label>Nova senha</label>
                  <input type="password" class="form-control" placeholder="Nova Senha" name="nvsenha" value=""> </div>
                <div class="form-group"> <label>Confirmar nova senha</label>
                  <input type="password" class="form-control" placeholder="Confirmar Nova Senha" name="cnvsenha" value=""> </div>
                <p style="float: right;">
              <a href="PortalAluno" class="btn btn-danger">Cancelar</a>
            </p><button type="submit" class="btn btn-dark" value="entrar" id="entrar" name="entrar">Alterar</button>
              </form>
