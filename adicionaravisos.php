        ...
        <div class="col-md-12">
          <div class="card ">
            <div class="card-body p-4">
              <form action="inseriraviso" method="post">
                <div class="form-group"> <label class="text-dark"><b>Título:</b><br></label>
                  <input class="form-control" placeholder="Título" name="titulo"> </div>
                <div class="form-group"> <label class="text-dark">Descrição:<br></label> <textarea name="ds" rows="5" class="form-control" id="InputDescricao" placeholder="Descrição"></textarea> </div>
                <button type="submit" class="btn mt-2 active btn-outline-danger">Adicionar</button>
              </form>
            </div>
          </div>
        </div>
